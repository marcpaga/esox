...
class RemoraModel(BaseRemoraModel):
    ...
    def forward(self, batch):
        ...
        #print('Seq emb size: {}'.format(seq_embeddings.shape))

        return self.lstm(torch.cat((sig_embeddings, seq_embeddings), 1))
    
# class RemoraModelTriplet(TripletRemoraModel):
#     """Classic Remora Model
#     """
#     def __init__(
#             self, 
...
#             **kwargs,
#         ):
#         super(RemoraModelTriplet, self).__init__(*args, **kwargs)
#         """
#         Args:
#         """
